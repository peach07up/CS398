...
main:
        ...
        la   $a0, matrix1       # TEST 1: (matrix1, 0, list1, 0)
        li   $a1, 0
        la   $a2, list1
        li   $a3, 0
        jal  matrix_column_matches_list_row          # call your function
        move $a0, $v0
        jal  print_int_and_space

        la   $a0, matrix1       # TEST 2: (matrix1, 1, list1, 0)
        li   $a1, 1
        la   $a2, list1
        li   $a3, 0
        jal  matrix_column_matches_list_row          # call your function
        ...
        la   $a0, matrix1       # TEST 3: (matrix1, 0, list1, 3)
        li   $a1, 0
        la   $a2, list1
        li   $a3, 3
        jal  matrix_column_matches_list_row          # call your function
        ...
        la   $a0, matrix2       # TEST 4: (matrix2, 2, list2, 2)
        li   $a1, 2
        la   $a2, list2
        li   $a3, 2
        jal  matrix_column_matches_list_row          # call your function
        ...
        la   $a0, matrix2       # TEST 4: (matrix2, 1, list2, 4)
        li   $a1, 1
        la   $a2, list2
        li   $a3, 4
        jal  matrix_column_matches_list_row          # call your function
        ...
        la   $a0, matrix2       # TEST 4: (matrix2, 1, list2, 0)
        li   $a1, 1
        la   $a2, list2
        li   $a3, 0
        jal  matrix_column_matches_list_row          # call your function
